...
class Boundaries(unittest.TestCase):
 ...
 def test_snapshot_generator_and_production_sources_unchanged(self):
  names=("openhtpc-capabilities.py","openhtpc-protected-optical.py","openhtpc-protected-optical-backend.py","openhtpc-play-optical","openhtpc-play-dvd","openhtpc-play","openhtpc-media-browser.py","openhtpc-tmdb.py","openhtpc-runtime-generator.py","openhtpc-gpu-policy.py","openhtpc-builder.sh","openhtpc-playback-policy.py")
  for name in names:
