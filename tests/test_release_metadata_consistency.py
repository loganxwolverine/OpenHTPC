...
CURRENT_BUILD_ID = "public-release-1.2.0-rc2"
...
class ReleaseMetadataConsistency(unittest.TestCase):
    ...
    def test_current_source_tree_is_consistent(self):
        ...
        self.assertEqual(values["top_version"], "1.2.0-rc2")
    ...
    def test_unchanged_flex_binary_records_rc1_product_identity(self):
        ...
        self.assertEqual(metadata["product_version"], "1.2.0-rc2")
    ...
    def test_1_2_0_rc2_builder_requires_human_physical_release_gate(self):
        builder = (ROOT / "tools/build-1.2.0-rc2.py").read_text(encoding="utf-8")
        self.assertIn('BUILD = "public-release-1.2.0-rc2"', builder)
        self.assertIn('"physical_qualification": "PENDING"', builder)
        self.assertIn('"protected_bluray_bitstream_fix": "SOFTWARE_PASS_PHYSICAL_VALIDATION_REQUIRED"', builder)
