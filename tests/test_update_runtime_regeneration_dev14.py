...
class Dev14UpdateRuntimeRegeneration(unittest.TestCase):
    ...
    def test_11_update_executes_and_preserves_persistent_state(self):
        ...
        for relative in ("plugins/README.md", "flex/bin/flex-launcher", "flex/BUILD-METADATA.json",
...
""")
        ...
        self.assertIn("1.1.3-dev14 / update-runtime-regeneration-dev14", (self.runtime / "pure.conf").read_text())
