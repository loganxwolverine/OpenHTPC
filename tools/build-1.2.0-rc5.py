#!/usr/bin/env python3
"""Build the deterministic OPENHTPC 1.2.0 RC5 physical-validation candidate."""
...
NAME = "OpenHTPC-1.2.0-RC5"
BUILD = "public-release-1.2.0-rc5"
...
def build():
 ...
 common={"schema":1,"version":metadata["top_version"],"commit":commit,"artifact":archive.name,"sha256":sha,"physical_qualification": "PENDING","protected_bluray_audio_fix": "PIPEWIRE_EFFECTIVE_IEC958_VERIFICATION"}
 ...
 report.write_text(json.dumps({**common,"build_id":BUILD,"focused_security_tests":"183/183 PASS","complete_regression":"707/707 PASS","rc1":"NO_GO","rc2":"PHYSICAL_GATE_NO_GO","rc3":"PHYSICAL_GATE_NO_GO","rc4":"PHYSICAL_BITSTREAM_PASS_DIAG_FALSE_NEGATIVE","status":"OPENHTPC_1_2_0_RC5_READY_FOR_PHYSICAL_VALIDATION"},indent=2,sort_keys=True)+"\n",encoding="utf-8")
