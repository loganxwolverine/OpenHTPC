#!/usr/bin/env python3
"""Build the deterministic OPENHTPC 1.2.0 RC6 physical-validation candidate."""
...
def build():
 ...
 common={"schema":1,"version":metadata["top_version"],"commit":commit,"artifact":archive.name,"sha256":sha,"physical_qualification": "PENDING","media_audio_fix": "MEDIA_PIPEWIRE_IEC958_RECOVERY"}
