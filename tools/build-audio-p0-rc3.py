#!/usr/bin/env python3
"""Build the bounded post-RC3 audio P0 physical-validation candidate."""
...
NAME = "OpenHTPC-1.1.1-RC3-Audio-P0"
...
def build() -> tuple[pathlib.Path, pathlib.Path, pathlib.Path]:
    ...
    report.write_text(json.dumps({"schema":1,"product":"OPENHTPC","version":"1.1.1-rc3","build_id":"post-rc3-audio-passthrough-p0-rc3",
