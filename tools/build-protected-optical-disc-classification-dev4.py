#!/usr/bin/env python3
"""Build the deterministic OPENHTPC protected-optical Dev4 artifact."""
from __future__ import annotations
import gzip,hashlib,os,pathlib,tarfile,tempfile
import openhtpc_release_metadata as release_metadata

ROOT=pathlib.Path(__file__).resolve().parents[1]
NAME="OpenHTPC-1.1.4-Protected-Optical-Disc-Classification-Dev4"
...
def build():
 ...
 if archive.exists() or sidecar.exists():raise FileExistsError("DEV4_ARTIFACT_COLLISION")
